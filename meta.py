...
class Package:
    def __init__(self, source_code: str):
        ...
        self.name = child_by_type_name(
            child_by_type_name(self.tree.root_node, "package_declaration"),
            "scoped_identifier",
        ).text.decode()
...
class Method:
    def __init__(self, method_declaration: Node, clazz: Class):
        ...
        parameters_type_list = [
            parameter.child_by_field_name("type").text.decode()
            for parameter in parameters
        ]
        self.signature: str = (
            clazz.qualified_name
            + "."
            + self.name
            + "("
